...
const projects = [
  { id: 'codevra-hq', title: 'Codevra HQ', description: 'Full-scale developer ecosystem with tools hub, secure vault, coding arena, learning tracker, and startup network.', category: 'web', tech: ['Next.js', 'TypeScript', 'Tailwind', 'PostgreSQL', 'Redis'], liveUrl: 'https://codevra.dev', githubUrl: 'https://github.com/codevra/hq', featured: true, status: 'In Development', architecture: 'Monorepo with API-first microservices architecture', lessons: 'Building a platform vs a project requires fundamentally different thinking about user journeys and data flow.' },
  { id: 'secure-vault', title: 'Secure Note Vault', description: 'End-to-end encrypted note storage for developers. AES-256 encryption with client-side key derivation.', category: 'security', tech: ['React', 'Node.js', 'AES-256', 'bcrypt', 'PostgreSQL'], liveUrl: '#', githubUrl: 'https://github.com/codevra/vault', featured: true, status: 'Beta', architecture: 'Zero-knowledge architecture — server never sees plaintext', lessons: 'Client-side encryption adds complexity but is non-negotiable for sensitive data.' },
  { id: 'mpesa-sdk', title: 'M-Pesa Integration SDK', description: 'Developer-friendly SDK for M-Pesa Daraja API. Simplifies STK push, B2C, and transaction queries.', category: 'web', tech: ['Node.js', 'TypeScript', 'M-Pesa API', 'Express'], liveUrl: 'https://npmjs.com/package/mpesa-sdk', githubUrl: 'https://github.com/codevra/mpesa-sdk', featured: false, status: 'Published', architecture: 'Modular SDK with promise-based API and automatic token management', lessons: 'African fintech APIs need better developer experience. Documentation is a product.' },
];
